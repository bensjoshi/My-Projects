...
public class RegularChefSignUpPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regular_chef_sign_page);
        ...
        db.collection("employees")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        // Add new user to Firestore with role = "Regular Chef"
                        DocumentReference newUserRef = db.collection("employees").document();
                        newUserRef.set(new User(username, password, "Regular Chef"))
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(this, "You successfully signed up as a Regular Chef.", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(RegularChefSignUpPage.this, RegularChefMainPage.class);
